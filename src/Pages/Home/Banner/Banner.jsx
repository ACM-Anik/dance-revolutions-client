        ...
        >
            {
                sliderCategories.map( category => <SwiperSlide key={category._id}>
                    <div className=''>
                        <img className='relativeh-[400px] md:h-[600px] object-cover' src={category.image} style={{width: '100%'}} alt="" />
                        <div className="absolute flex items-center justify-center text-center h-full left-0 bottom-0 right-0 rounded bg-gradient-to-t from-[#111010] to-[#11101030]">
                                <div className='text-white space-y-6 w-5/6 lg:w-1/2 mx-auto'>
                                    ...
                                    <div className='flex justify-center items-center gap-2'>
                                        <button className='btn text-black rounded-lg border-0 bg-white hover:bg-[#eaeaea]'>Explore All</button>
                                        <button className='btn btn-outline text-white rounded-lg border-black  hover:bg-[#1c1b1b]'>Contact Us</button>
                                    </div>
                                </div>
                            </div>
                    </div>
